...
# 23+ minutter fra kl 15:06 af -Michael
# 13 min endnu. - for de første 2 filer den giver mig ikke et estimat for nummerplade filen. så 13 min + w/e den anden tager.
...
def main():
    ...
    imgOriginalScene = cv2.imread(
        "LicPlateImages/5.png")               # open image
